...
from ..bot.user_preferences import get_user_gemini_thinking_budget_preference
...
class StreamProcessor:
    ...
    async def process_stream(
        ...
        for attempt_num in range(2):
            ...
            attempt_result = await self._process_single_attempt(
                ...
                current_params, initial_user_warnings,
    ...
    async def _setup_retry(self, attempt_num, original_params, initial_user_warnings,
                          processing_msg, response_msgs, new_msg):
    ...
    async def _process_single_attempt(self, new_msg, processing_msg, response_msgs,
                                    current_params, initial_user_warnings,
                                    use_plain_responses_config, split_limit_config,
                                    custom_search_queries_generated, successful_api_results_count,
                                    deep_search_used, history_for_llm, attempt_num):
