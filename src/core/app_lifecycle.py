...
class AppLifecycleManager:
    ...
    def create_discord_client(self) -> LLMCordClient:
        ...
        activity = discord.CustomActivity(
            name=(self.config.get("status_message") or "github.com/jakobdylanc/llmcord")[:128]
        )
    ...
    def log_invite_url(self):
        ...
        if client_id:
            ...
            logger.warning("client_id not found in config.yaml. Cannot generate invite URL")
    ...
    async def start_bot(self) -> None:
        ...
        try:
            ...
            logger.critical("Failed to log in. Please check your bot_token in config.yaml")
            raise
    ...
    async def _cleanup_shared_html(self) -> None:
        ...
        if cleanup_enabled:
            ...
            try:
                ...
                logger.error(f"Error cleaning up shared HTML directory: {e}", exc_info=True)
        else:
